      ...
      <footer>
        ...
        >
          <p style={{ marginBottom: "10px" }}>
            📍 ДИСКЛЕЙМЕР: Данный канал содержит исключительно личные гипотезы, наблюдения и оценочные суждения автора.
            Все мнения основаны на общедоступных данных и личной оценке; они не претендуют на абсолютную достоверность.
            Автор не имеет медицинского образования, данный канал выражает его частную точку зрения, основанную на
            личном опыте и только. Обязательно проконсультируйтесь со своим лечащим врачом!!!
          </p>
          <p>
            📌 ОТКАЗ ОТ ОТВЕТСТВЕННОСТИ: Информация, представленная в данной программе, носит исключительно
            информационный и развлекательный характер и не является психотерапевтическими услугами или формой
            медицинского/психологического консультирования. Несмотря на опыт психолога, автор не оказывает
            профессиональную психотерапевтическую поддержку или медицинскую помощь в рамках данного проекта. Все
            методы, рекомендации и советы, предлагаемые в материалах, направлены на саморазвитие и работу над собой.
            Любое применение полученных знаний и практик осуществляется исключительно на ваш страх и риск. Автор не
            несёт ответственности за возможные последствия вашего личного выбора и действий. Если у вас возникают
            серьёзные эмоциональные трудности, симптомы психического расстройства или иные проблемы со здоровьем,
            пожалуйста, обратитесь к квалифицированному специалисту. Внимательно ознакомьтесь со всеми материалами,
            прежде чем приступать к каким-либо действиям.
          </p>
        </div>
